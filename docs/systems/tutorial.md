...
**Project 창 → 우클릭 → Create → SS/Tutorial/Tutorial Sequence**
...
```csharp
[CreateAssetMenu(menuName = "SS/Tutorial/Steps/My Step")]
...
```
SS_Tutorial_Completed = "FirstGacha,FirstEquip,FirstDungeon"
```
